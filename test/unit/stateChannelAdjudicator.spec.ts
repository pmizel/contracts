...
const StateChannelAdjudicator = artifacts.require("StateChannelAdjudicator");
...
// LINK
// TODO: Do I need to do this? It's in migrations
StateChannelAdjudicator.link("Signatures", Signatures.address);
StateChannelAdjudicator.link("StaticCall", StaticCall.address);
...
contract("StateChannel", (accounts: string[]) => {
  ...
  before(async () => {
    judge = await Utils.deployContract(
